...
| node_reserve2 | 192.168.200.87 | Swarm worker, Ollama, ComfyUI | key auth | Ubuntu 24.04 |
...
ssh swarm_user@192.168.200.87 "command here"               # node_reserve2
```

### Fleet Health Check
```bash
for host in 10.0.0.20 10.0.0.10 192.168.200.87 10.0.0.30; do
    echo "=== $host ==="
